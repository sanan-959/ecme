...
const ClassModal = ({ openModal, closeModal }) => {
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                <div className="bg-secondary rounded-lg shadow-lg w-96">
                    <div className="flex items-center justify-between mb-4 bg-inputbg p-2 rounded-t-lg">
                        {/* Title */}
                        <span className="text-lg font-semibold text-center text-dark">Add Class</span>
                        {/* Close Button */}
                    ...
                    <div>
                        <form>
                            <div className="mb-4 px-4 ">
                                <label className="block text-sm font-medium text-accent">Class Name</label>
                                <input type="text" className="mt-1 block bg-inputbg w-full text-dark border border-inputbg focus:border-muted rounded-md shadow-sm p-2 focus:outline-none focus:ring-1 focus:ring-muted" placeholder="Enter class name" />
                            </div>
