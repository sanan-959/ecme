        ...
        <div className=" flex justify-between bg-white h-[60px] shadow-sm px-3 lg-px-7 ">
            <div className="flex items-center space-x-1 lg:space-x-3">
                <div className="w-[40px] h-[40px] hover:bg-gray-200 flex items-center justify-center rounded-full p-3">
                    <a href="#" className="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-gray-800 dark:text-white" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <div className="flex">
                <ul className="flex items-center space-x-1 lg:space-x-4">
                    <li>
                        <div className="w-[40px] h-[40px] hover:bg-gray-200 flex items-center justify-center rounded-full p-3">
                            <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar1" class=""><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    ...
                    <li>
                        <div className="w-[40px] h-[40px] hover:bg-gray-200 flex items-center justify-center rounded-full p-3">
                            <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar2" class=""><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    ...
                    <li>
                        <div className="w-[40px] h-[40px] hover:bg-gray-200 flex items-center justify-center rounded-full p-3">
                            <button class=""><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
